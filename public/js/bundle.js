...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoibmFyaW1hbjc3IiwiYSI6ImNreG1laXI5djFwcXoyd3ViNWNwOTZ5YnoifQ.rJI6_D5ZbaqYcN6F363aUw';
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 7:
            ...
            return _context.abrupt("return", (0, _alerts.showAlert)('error', 'This email has already exist!'));

          case 11:
            if (!_context.t0.response.data.error.errors.passwordConfirm) {
              _context.next = 13;
              break;
            }

            return _context.abrupt("return", (0, _alerts.showAlert)('error', 'Passwords do not match'));
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 12:
            if (!(_context.t0.response.data.message == "You're password is wrong")) {
              _context.next = 14;
              break;
            }

            return _context.abrupt("return", (0, _alerts.showAlert)('error', 'Current password is wrong'));
...
var updateUserForm = document.getElementById('form-userData');
var updateUserPassword = document.getElementById('form-user-password'); // DELIGATION
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              console.log(form);
              document.getElementById('btn-save-setting').textContent = 'Updating ...'; // VALUES
      ...
      return regeneratorRuntime.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              e.preventDefault();
              document.getElementById('btn-save-password').textContent = 'Updating ...'; // VALUES
